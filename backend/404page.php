					...
					<div class="row g-0">
						<div class="col col-xl-5">
							<div class="card-body p-4">
								...
								<div class="mt-5"> <a href="../frontend/register.php" class="btn btn-primary btn-lg px-md-5 radius-30">Go Home</a>
									<a href="../frontend/login.php" class="btn btn-outline-dark btn-lg ms-3 px-md-5 radius-30">Back</a>
								</div>
							</div>
						</div>
						<div class="col-xl-7">
